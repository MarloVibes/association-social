...
import { buildVisibleIdentity, normalizeNbaTierLabel } from '@/domain/nba/identity';
...
function validVisibleNbaIdentity(value: any): VisibleNbaIdentity | null {
...
function buildFallbackVisibleNbaIdentity(player: any, profile: any): VisibleNbaIdentity {
  const source = {
    ...(profile?.source || {}),
...
export default function FranchisePlayerRow({
  ...
  const rowIdentity = isNbaSport ? (visibleNbaIdentity(player, profile) || buildFallbackVisibleNbaIdentity(player, profile)) : null;
