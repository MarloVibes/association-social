...
const styles = StyleSheet.create({
  ...
  compareHeader: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0b0b0b', borderRadius: 8, borderWidth: 1, borderColor: '#222', padding: 10, marginBottom: 10 },
  compareHeaderSide: { flex: 1, minWidth: 0, alignItems: 'center' },
  compareHeaderName: { color: '#ffffff', fontSize: 13, fontWeight: '900', textAlign: 'center' },
  compareHeaderMeta: { color: '#777', fontSize: 10, fontWeight: '800', marginTop: 2, textAlign: 'center' },
  compareVs: { width: 44, color: '#00ff87', fontSize: 11, fontWeight: '900', textAlign: 'center' },
  compareRows: { gap: 7 },
  compareRow: { minHeight: 48, flexDirection: 'row', alignItems: 'center', backgroundColor: '#101010', borderRadius: 8, borderWidth: 1, borderColor: '#222', padding: 8 },
  compareGradeColumn: { flex: 1, minWidth: 0, alignItems: 'center' },
  ...
  compareAbilityLabel: { width: 112, color: '#ffffff', fontSize: 11, fontWeight: '900', textAlign: 'center' },
