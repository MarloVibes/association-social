...
async function verifyPitchDemo() {
  ...
  assert(nonCpuTeams.length === 0, `Expected all teams to be CPU-controlled; found ${nonCpuTeams.length} exceptions.`);
  ...
  console.log(`Teams: ${teamsSnap.size} (all CPU-controlled)`);
