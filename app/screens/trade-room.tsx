...
const styles = StyleSheet.create({
  ...
  positionFilterBtn: { minWidth: 54, height: 38, paddingHorizontal: 14, borderRadius: 999, backgroundColor: '#141414', borderWidth: 1, borderColor: '#2a2a2a', alignItems: 'center', justifyContent: 'center' },
