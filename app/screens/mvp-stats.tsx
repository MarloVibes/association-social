...
export default function MVPStatsScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.center}>
        ...
        <Text style={styles.desc}>Track your performance stats across game modes. Win-loss records, scoring averages, and more.</Text>
      </View>
    </View>
  );
}
