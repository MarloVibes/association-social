...
export default function MVPProAmScreen() {
  const router = useRouter();
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={() => router.back()}><Text style={styles.backLink}>← Back</Text></TouchableOpacity>
        <Text style={styles.title}>Pro-Am</Text>
        <View style={{ width: 60 }} />
      </View>
      <View style={styles.center}>
        <Text style={styles.icon}>🏆</Text>
        <Text style={styles.heading}>Coming Soon</Text>
        <Text style={styles.desc}>Manage your team and game history. Leader-only roster controls + searchable head-to-head records.</Text>
      </View>
    </View>
  );
}
