    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
        <Stack screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen name="screens/offseason/index" />
          <Stack.Screen name="screens/offseason/draft-class" />
          <Stack.Screen name="screens/offseason/live-draft" />
          <Stack.Screen name="screens/offseason/re-signing" />
          <Stack.Screen name="screens/offseason/free-agency" />
          <Stack.Screen name="screens/offseason/roster-cuts" />
          <Stack.Screen name="screens/offseason/expansion" />
          <Stack.Screen name="screens/season/rotation" />
          <Stack.Screen name="screens/season/coaching-presets" />
          <Stack.Screen name="screens/season/calendar" />
          <Stack.Screen name="screens/season/standings" />
          <Stack.Screen name="screens/season/playoffs" />
